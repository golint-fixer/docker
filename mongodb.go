...
const (
	// ImageMongoDBName defines the name of MongoDB image from Docker repository.
	ImageMongoDBName = "mongo"
	// MongoDBPortDefault defines default port for MongoDB.
	MongoDBPortDefault = 27017
)
